    ...
    <div class="services">
        <div class="container">
            <div class="services-main">
                <h2>欧式风格</h2>
                <div class="col-xs-6">
                    <img class="news-img" src="mis/images/3/1.jpg"/>
                </div>
                <div class="col-xs-6">
                    <img class="news-img" src="mis/images/3/2.jpg"/>
                </div>
                <div class="col-xs-6">
                    <img class="news-img" src="mis/images/3/3.jpg"/>
                </div>
                <div class="col-xs-6">
                    <img class="news-img" src="mis/images/3/3.jpg"/>
                </div>
                ...
                <p class="news-content">
                    <?php
                    $file = fopen("mis/article/article3.txt","r");
                    echo fread($file,filesize("mis/article/article3.txt"));
                    fclose($file);
                    ?>
